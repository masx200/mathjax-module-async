...
var x = [ "core", "input/asciimath", "output/chtml", "input/tex-full", "input/mml", "output/chtml/fonts/tex" ].map(h), d = [ m, h("startup"), p ].concat(u(x));
...
function w() {
    return (w = e(regeneratorRuntime.mark((function t() {
        ...
        return regeneratorRuntime.wrap((function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
                return t.next = 2, Promise.all(d.map((function(t) {
                    return i(t);
                })));
...
function P() {
    return (P = e(regeneratorRuntime.mark((function t(e, n) {
        var r, o, u;
        return regeneratorRuntime.wrap((function(t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
